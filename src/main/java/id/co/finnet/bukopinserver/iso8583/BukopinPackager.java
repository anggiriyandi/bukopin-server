...
public class BukopinPackager extends ISOBasePackager{
    ...
    protected ISOFieldPackager[] fieldList = {
        ...
        /*021*/ new IFA_NUMERIC(21, "Country code, Forwarding institution"),
        ...
        /*032*/ new IFA_LLNUM(7, "Acquirer institution identification code"),
        /*033*/ new IFA_LLNUM(7, "Forwarding institution identification code"),
        ...
        /*040*/ new IFA_NUMERIC(3, "Action code"),
